...
const projects = [{"name": "Save our Roots", "flairs": [{"type": "C#", "colour": "green"}, {"type": "Unity", "colour": "black"}, {"type": "WINNER!", "colour": "gold"}], "images": [{'title':'RootHacks','url':'icons/medium (1).png'},{'title':'RootHacks','url':'images/medium (1).png'},{'title':'RootHacks','url':'images/medium (1).png'},{'title':'RootHacks','url':'images/medium (1).png'}, {'title':'RootHacks','url':'images/medium (1).png'}], "body": `In this video game, the player takes on the role of John, a man who wakes up from a coma to find himself in a world overrun by zombies. He discovers that he possesses antibodies that can cure the virus and sets out on a mission to reach the World Health Organization lab to deliver his blood and save humanity.
