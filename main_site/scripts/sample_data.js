...
const projects = [
    {
        "name": "C++ 3D Game Engine", "flairs": [{ "type": "Linear Algebra", "colour": "red" }, { "type": "C++", "colour": "cyan" }, { "type": "Computer Graphics", "colour": "pink" }, { "type": "Systems", "colour": "grey" }, { "type": "Personal", "colour": "silver" }], "images": [{ 'title': 'RootHacks', 'url': 'images/render1.jpg' }, { 'title': 'RootHacks', 'url': 'images/render2.jpg' }, { 'title': 'RootHacks', 'url': 'images/render3.jpg' }, { 'title': 'RootHacks', 'url': 'images/render4.jpg' }, { 'title': 'RootHacks', 'url': 'images/render5.jpg' }],
...
.`, "collabs": [], "img_url": 'images/icons_renderer.png', "url": "https://github.com/kennyzhang620/3DRenderer_Cpp"
    ...
    {
        "name": "Save our Roots", "flairs": [{ "type": "C#", "colour": "green" }, { "type": "Unity", "colour": "black" }, { "type": "WINNER!", "colour": "gold" }, { "type": "SystemsHacks2023", "colour": "blue" }], "images": [{ 'title': 'RootHacks', 'url': 'icons/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }],
    ...
    {
        "name": "Missing Mystery", "flairs": [{ "type": "C#", "colour": "green" }, { "type": "Unity", "colour": "black" }, { "type": "WINNER!", "colour": "gold" }, { "type": "nwHacks2023", "colour": "blue" }], "images": [{ 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }],
    ...
    {
        "name": "Plant Scan", "flairs": [{ "type": "Node.js", "colour": "green" }, { "type": "Express.js", "colour": "black" }, { "type": "AvaGrows", "colour": "gold" }, { "type": "ML/CNN", "colour": "red" }, { "type": "bcrypt", "colour": "purple" }], "images": [{ 'title': 'RootHacks', 'url': 'images/ps1.jfif' }, { 'title': 'RootHacks', 'url': 'images/ps2.jfif' }, { 'title': 'RootHacks', 'url': 'images/ps3.jfif' }, { 'title': 'RootHacks', 'url': 'images/ps4.jfif' }, { 'title': 'RootHacks', 'url': 'images/ps5.jfif' }],
...
Users will be able to login (or be prompted to create a new account), take or upload a picture of a plant, and see information regarding its identity and health using machine learning from the [Plant.id] (https://web.plant.id/) API. They will also be able to filter the plants being displayed on their dashboard by attributes such as whether the plant is healthy and whether the plant is edible.
    ...
    {
        "name": "Maztrik", "flairs": [{ "type": "C#", "colour": "green" }, { "type": "Unity", "colour": "black" }, { "type": "Personal", "colour": "silver" }, { "type": "Rootfinding/Math", "colour": "red" }], "images": [{ 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }],
    ...
    {
        "name": "Infinite Block Madness", "flairs": [{ "type": "C#", "colour": "green" }, { "type": "Unity", "colour": "black" }, { "type": "Personal", "colour": "silver" }], "images": [{ 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }],
    ...
    {
        "name": "Block-Align", "flairs": [{ "type": "C#", "colour": "green" }, { "type": "Unity", "colour": "black" }, { "type": "Personal", "colour": "silver" }], "images": [{ 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }, { 'title': 'RootHacks', 'url': 'images/medium (1).png' }],
